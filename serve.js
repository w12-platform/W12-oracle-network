...
app.get(['/project-settings', '/project-settings.html'], (req, res) => res.render('project-settings.html', { VERSION }));
app.get(['/admin-project-settings', '/admin-project-settings.html'], (req, res) => res.render('admin-project-settings.html', { VERSION }));
